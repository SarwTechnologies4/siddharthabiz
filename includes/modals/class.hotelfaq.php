...
class Hotelfaq extends DatabaseObject
{

    protected static $table_name = "tbl_hotel_faqs";
    protected static $db_fields = array('id', 'title', 'content', 'status', 'sortorder', 'added_date');
