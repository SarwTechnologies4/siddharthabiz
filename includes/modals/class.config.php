...
class Config extends DatabaseObject
{
    ...
    protected static $db_fields = array(
        ...
        'mail_address', 'contact_info', 'contact_phone', 'email_address', 'breif', 'copyright', 'site_keywords', 'site_description', 'google_anlytics', 'template',
        'admin_template', 'headers', 'footer', 'search_box', 'search_result', 'action', 'fb_messenger', 'pixel_code', 'schema_code', 'robot_txt', 'meta_title'
    );
    ...
    public $action;
    public $fb_messenger, $pixel_code, $schema_code, $robot_txt, $meta_title;
