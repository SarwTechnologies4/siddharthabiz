...
class EventHall extends DatabaseObject
{

    protected static $table_name = "tbl_event_hall";
    protected static $db_fields = array(
            'id', 'hotel_id', 'title', 'slug', 'image', 'area', 'theater', 'circular', 'u_shaped', 'board_room', 'class_room', 'reception', 'content',
        'status', 'sortorder', 'added_date', 'modified_date', 'meta_keywords', 'meta_description'
    );

    public $id, $hotel_id, $title, $slug, $image, $area, $theater, $circular, $u_shaped, $board_room, $class_room, $reception, $content,
