...
class ShareholderType extends DatabaseObject
{

    protected static $table_name = "tbl_shareholders_type";
    protected static $db_fields = array('id', 'title', 'status', 'sortorder');
