...
class Bookinginfo extends DatabaseObject
{
    ...
    protected static $db_fields = array(
        'id', 'pkg_id', 'vendor_id', 'subpkg_id', 'user_id',  'fixed_date_id', 'trip_date', 'date_rate', 'trip_currency', 'trip_pax', 'trip_flight',
        'accesskey', 'person_title', 'person_fname', 'person_mname', 'person_lname', 'person_email', 'person_country',
        'person_country_code', 'person_city', 'person_address', 'person_postal', 'person_phone', 'person_ctype', 'person_hear',
