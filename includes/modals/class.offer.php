<?php
class offer extends DatabaseObject {

	protected static $table_name = "tbl_page";
	protected static $db_fields = array('id', 'slug', 'title', 'content', 'linksrc', 'status', 'sortorder', 'meta_keywords', 'meta_description', 'type', 'added_date', 'homepage', 'image');
