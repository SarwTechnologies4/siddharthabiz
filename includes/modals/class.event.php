...
class Event extends DatabaseObject
{
    ...
    protected static $table_name = "tbl_event";
    protected static $db_fields = array('id', 'hotel_id', 'category_id', 'title', 'slug', 'image', 'content', 'status', 'sortorder', 'added_date', 'modified_date', 'meta_keywords', 'meta_description');

    public $id, $hotel_id, $category_id, $title, $slug, $image, $content, $status, $sortorder, $added_date, $modified_date;
