...
class DiningHall extends DatabaseObject
{

    protected static $table_name = "tbl_dining_hall";
    protected static $db_fields = array('id', 'hotel_id', 'title', 'slug', 'image', 'content', 'status', 'sortorder', 'added_date','meta_keywords', 'meta_description', 'modified_date');

    public $id, $hotel_id, $title, $slug, $image, $content, $status, $sortorder, $added_date, $modified_date;
