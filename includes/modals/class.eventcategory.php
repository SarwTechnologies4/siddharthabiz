...
class EventCategory extends DatabaseObject
{

    protected static $table_name = "tbl_event_category";
    protected static $db_fields = array('id', 'slug', 'title', 'content', 'status', 'sortorder', 'added_date', 'modified_date');

    public $id, $slug, $title, $content, $status, $sortorder, $added_date, $modified_date;
