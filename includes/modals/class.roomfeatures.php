<?php
class Roomfeatures extends DatabaseObject {

	protected static $table_name = "tbl_roomfeatures";
	protected static $db_fields = array('id', 'parent_id','title', 'icon_class', 'image', 'status', 'sortorder', 'added_date');
