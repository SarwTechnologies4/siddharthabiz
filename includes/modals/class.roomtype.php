...
class Roomtype extends DatabaseObject
{
    ...
    protected static $table_name = "tbl_roomtype";
    protected static $db_fields = array('id', 'hotel_id', 'title', 'slug', 'description', 'status', 'sortorder', 'added_date');
    ...
    public static function get_all($hotel_id)
    {
        global $db;
        return self::find_by_sql("SELECT * FROM " . self::$table_name . " WHERE status='1' and hotel_id='$hotel_id' ORDER BY sortorder ASC");
    }
    ...
    public static function find_all_by_type($hotel_id = '')
    {
        global $db;
        return self::find_by_sql("SELECT * FROM " . self::$table_name . " WHERE hotel_id='$hotel_id' ORDER BY sortorder ASC");
    }
