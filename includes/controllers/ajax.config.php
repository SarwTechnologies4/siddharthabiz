<?php 
	...
	{		
		...
		case "edit":
			...
			$record->sitetitle 			= $_REQUEST['sitetitle'];					
			$record->sitename			= $_REQUEST['sitetitle'];
			$record->copyright 			= $_REQUEST['copyright'];
			$record->site_keywords		= $_REQUEST['site_keywords'];
			$record->site_description	= $_REQUEST['site_description'];
			$record->google_anlytics	= $_REQUEST['google_anlytics'];
...
//			$record->footer 			= $_REQUEST['footer'];
            ...
            $record->fb_messenger       = (!empty($_REQUEST['fb_messenger'])) ? $_REQUEST['fb_messenger'] : '';
            $record->pixel_code         = (!empty($_REQUEST['pixel_code'])) ? $_REQUEST['pixel_code'] : '';
            $record->schema_code        = (!empty($_REQUEST['schema_code'])) ? $_REQUEST['schema_code'] : '';
            $record->robot_txt          = (!empty($_REQUEST['robot_txt'])) ? $_REQUEST['robot_txt'] : '';
		...
		case "locationedit":
			...
			$record->contact_phone 	= $_REQUEST['contact_phone'];
