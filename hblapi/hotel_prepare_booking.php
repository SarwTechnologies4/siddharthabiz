...
foreach($no_of_room as $key=>$val): if(!empty($val)){ ?>
    ...
    <div class="row">
        <div class="form-group">
            <div class="col-sm-12">  
                <p>
                    <!-- <label><input type='radio' name="payment_method" value="himalayanBank" checked="checked"> <img class="img-responsive hide-radio" src="<?php echo $api_baseurl;?>hblapi/images/paylog.png" width="210px" style="position: relative;float: right;"> -->
