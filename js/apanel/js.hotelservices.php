<script language="javascript">
    ...
    function getLocation() {
        return '<?php echo BASE_URL;?>includes/controllers/ajax.hotelservices.php';
    }
    ...
    $(document).ready(function () {
        oTable = $('#example').dataTable({
            ...
            sURL: "<?php echo BASE_URL;?>includes/controllers/ajax.hotelservices.php?action=sort",
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (msg.action == 'success') {
                                ...
                                if (actionId == 2)
                                    setTimeout(function () {
                                        window.location.href = "<?php echo ADMIN_URL?>hotelservices/list";
                                    }, 3000);
                                if (actionId == 1)
                                    setTimeout(function () {
                                        window.location.href = "<?php echo ADMIN_URL?>hotelservices/addEdit";
                                    }, 3000);
                                if (actionId == 0)
                                    setTimeout(function () {
    ...
    /***************************************** View services child Lists *******************************************/
    function viewChildlist(Re) {
        window.location.href = "<?php echo ADMIN_URL?>hotelservices/list/" + Re;
    }
    ...
    /***************************************** Edit records *****************************************/
    function editRecord(Re) {
        window.location.href = "<?php echo ADMIN_URL?>hotelservices/addEdit/" + Re;
    }
