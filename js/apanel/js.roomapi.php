...
function getLocation(){
	return '<?php echo BASE_URL;?>includes/controllers/ajax.roomapi.php';
}
function getTableId(){
	return 'table_dnd';
}
...
$(document).ready(function() {
	oTable = $('#example').dataTable({
		...
		"sPaginationType": "full_numbers"
		  ...
		  sURL:"<?php echo BASE_URL;?>includes/controllers/ajax.roomapi.php?action=sort",
...
$(document).ready(function(){	
	...
	jQuery('#roomapi_frm').validationEngine({
		autoHidePrompt:true,
		...
		onValidationComplete: function(form, status){
			if(status==true){	
				...
				var data = $('#roomapi_frm').serialize();
				...
				$.ajax({
				   ...
				   success: function(data){
					   ...
					   if(msg.action=='success'){
						   ...
						   setTimeout( function(){window.location.href="<?php echo ADMIN_URL?>roomapi/list";},3000);						   		
					   }
...
function recordDelete(Re){
	$('.MsgTitle').html('<?php echo sprintf($GLOBALS['basic']['deleteRecord_'],"Room")?>');															
...
{
	window.location.href="<?php echo ADMIN_URL?>roomapi/list";
}

/***************************************** Add New Room *******************************************/
function AddNewRoom()
{
	window.location.href="<?php echo ADMIN_URL?>roomapi/form";
}

/***************************************** Edit records *****************************************/
function editRecord(Re)
{
	window.location.href="<?php echo ADMIN_URL?>roomapi/form/"+Re;
}
...
{
	window.location.href="<?php echo ADMIN_URL?>roomapi/roomImageList/"+Re;
}
...
{   var rowNum = Math.floor((Math.random()*999)+1);	
	var newRow ='<div><input type="checkbox" class="custom-radio" name="feature['+feature_id+']['+rowNum+'][id]" value="'+rowNum+'" checked="checked" >';
