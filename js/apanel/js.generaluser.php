<script language="javascript">
    ...
    function getLocation() {
        return '<?php echo BASE_URL;?>includes/controllers/ajax.generaluser.php';
    }
    ...
    $(document).ready(function () {
        ...
        $('#column7_filter').keyup(function () {oTable.fnFilter(this.value, 7);});
...
// });
    ...
    function AddNewUsers() {
        window.location.href = "<?php echo ADMIN_URL?>generaluser/addEdit";
    }

    /***************************************** View Users Lists *******************************************/
    function viewuserslist() {
        window.location.href = "<?php echo ADMIN_URL?>generaluser/list";
    }

    /***************************************** Edit User login Info *******************************************/
    function editRecord(Re) {
        window.location.href = "<?php echo ADMIN_URL?>generaluser/addEdit/" + Re;
    }
    function updateRecord(Re) {
        window.location.href = "<?php echo ADMIN_URL?>generaluser/update/" + Re;
    }
    function editRecordSub(Re,De) {
        window.location.href = "<?php echo ADMIN_URL?>generaluser/update/" + Re + "/" +De;
    }
    function correctRecord(Re) {
        window.location.href = "<?php echo ADMIN_URL?>generaluser/correct/" + Re;
    }
    /***************************************** AddEdit login Info *******************************************/
    $(document).ready(function () {
    ...
    $(document).ready(function () {
        // form submisstion actions
        jQuery('#adminusersetting_frm_correction').validationEngine({
            prettySelect: true,
            useSuffix: "_chosen",
            autoHidePrompt: true,
            scroll: false,
            onValidationComplete: function (form, status) {
                if (status == true) {
                    $('#btn-submit').attr('disabled', 'true');
                    var action = ($('#idValue').val() == 0) ? "action=addCorrection&" : "action=addCorrection&";
                    var data = $('#adminusersetting_frm_correction').serialize();
                    queryString = action + data;
                    $.ajax({
                        type: "POST",
                        dataType: "JSON",
