                                ...
                                case 1:
                                    setTimeout(function() {
                                        window.location.href =
                                            "<?php echo ADMIN_URL?>payment/addEdit";
                                    }, 3000);
                                    break;
                                case 2:
                                    setTimeout(function() {
                                        window.location.href =
                                            "<?php echo ADMIN_URL?>payment/list";
                                    }, 3000);
                                    break;
                                default:
                                    if (action === 'edit') {
...
$(function() {
    $('#export_company_payment, #export_payment').on('click', function(e) {
        e.preventDefault();
        let ID = $(this).attr('id');
        let form = $(this).parent().find('form')[0];
        $(form).attr('action', "<?php echo BASE_URL ?>apanel/payment/" + ID + ".php").submit();
    });
