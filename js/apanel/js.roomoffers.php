...
function getLocation(){
	return '<?php echo BASE_URL;?>includes/controllers/ajax.roomoffers.php';
}
function getTableId(){
	return 'table_dnd';
}
...
$(document).ready(function() {
	oTable = $('#example').dataTable({
		...
		"sPaginationType": "full_numbers"
		  ...
		  sURL:"<?php echo BASE_URL;?>includes/controllers/ajax.roomoffers.php?action=sort",
...
{
	window.location.href="<?php echo ADMIN_URL?>roomoffers/list";
}

/***************************************** Add New offers *******************************************/
function AddNewOffers()
{
	window.location.href="<?php echo ADMIN_URL?>roomoffers/addEdit";
}

/***************************************** Edit records *****************************************/
function editRecord(Re)
{
	window.location.href="<?php echo ADMIN_URL?>roomoffers/addEdit/"+Re;
}
...
$(document).ready(function(){	
   $(".apply_for").on("click",function(){
       var v  = $(this).val();
		       $.ajax({
					   type: "POST",
					   dataType:"JSON",
					   url:  getLocation(),
					   data: 'action=change_apply_for&v='+v,
					   success: function(data){
						   var msg = eval(data);
						    $("#apply_id").html(msg.contents);		   
					   }
					});
   });
});
