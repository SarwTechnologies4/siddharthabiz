<script language="javascript">
    ...
    function getLocation() {
        return '<?php echo BASE_URL;?>includes/controllers/ajax.eventhall.php';
    }
    ...
    $(document).ready(function () {
        oTable = $('#example').dataTable({
            ...
            sURL: "<?php echo BASE_URL;?>includes/controllers/ajax.eventhall.php?action=sort",
    ...
    $(document).ready(function () {
        ...
        jQuery('#event_hall_frm').validationEngine({
            autoHidePrompt: true,
            ...
            onValidationComplete: function (form, status) {
                if (status == true) {
                    ...
                    var data = $('#event_hall_frm').serialize();
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (msg.action == 'success') {
                                ...
                                setTimeout(function () {
                                    window.location.href = "<?php echo ADMIN_URL?>eventhall/list";
                                }, 3000);
                            }
    ...
    /***************************************** View Lists *******************************************/
    function viewEventHallList() {
        window.location.href = "<?php echo ADMIN_URL?>eventhall/list";
    }

    /***************************************** Add New Record *******************************************/
    function addNewEventHall() {
        window.location.href = "<?php echo ADMIN_URL?>eventhall/form";
    }

    /***************************************** Edit records *****************************************/
    function editRecord(Re) {
        window.location.href = "<?php echo ADMIN_URL?>eventhall/form/" + Re;
    }
