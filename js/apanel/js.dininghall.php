<script language="javascript">
    ...
    function getLocation() {
        return '<?php echo BASE_URL;?>includes/controllers/ajax.dininghall.php';
    }
    ...
    $(document).ready(function () {
        oTable = $('#example').dataTable({
            ...
            sURL: "<?php echo BASE_URL;?>includes/controllers/ajax.dininghall.php?action=sort",
    ...
    $(document).ready(function () {
        ...
        jQuery('#dining_hall_frm').validationEngine({
            autoHidePrompt: true,
            ...
            onValidationComplete: function (form, status) {
                if (status == true) {
                    ...
                    var data = $('#dining_hall_frm').serialize();
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (msg.action == 'success') {
                                ...
                                setTimeout(function () {
                                    window.location.href = "<?php echo ADMIN_URL?>dininghall/list";
                                }, 3000);
                            }
    ...
    /***************************************** View Lists *******************************************/
    function viewDiningHallList() {
        window.location.href = "<?php echo ADMIN_URL?>dininghall/list";
    }

    /***************************************** Add New Record *******************************************/
    function addNewDiningHall() {
        window.location.href = "<?php echo ADMIN_URL?>dininghall/form";
    }

    /***************************************** Edit records *****************************************/
    function editRecord(Re) {
        window.location.href = "<?php echo ADMIN_URL?>dininghall/form/" + Re;
    }
