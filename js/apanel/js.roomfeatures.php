...
function getLocation(){
	return '<?php echo BASE_URL;?>includes/controllers/ajax.roomfeatures.php';
}
function getTableId(){
	return 'table_dnd';
}
...
$(document).ready(function() {
	oTable = $('#example').dataTable({
		...
		"sPaginationType": "full_numbers"
		  ...
		  sURL:"<?php echo BASE_URL;?>includes/controllers/ajax.roomfeatures.php?action=sort",
...
$(document).ready(function() {
	oTable = $('#subexample').dataTable({
		...
		"sPaginationType": "full_numbers"
		  ...
		  sURL:"<?php echo BASE_URL;?>includes/controllers/ajax.roomfeatures.php?action=subSort",
		  fnSuccess: function(message) { 
					var msg = jQuery.parseJSON(message);
					showMessage(msg.action,msg.message);
			   }
				...
				$.ajax({
				   ...
				   success: function(data){
					   ...
					   if(msg.action=='success'){
						   ...
						   if(actionId==2)
						   	setTimeout( function(){window.location.href="<?php echo ADMIN_URL?>roomfeatures/list/"+actionlist;},3000);						   	
						   if(actionId==1)	
						   	setTimeout( function(){window.location.href="<?php echo ADMIN_URL?>roomfeatures/addEdit";},3000);						   	
						   if(actionId==0)
...
/***************************************** View roomfeatures Lists *******************************************/
function viewFeatureslist(Re)
{
	window.location.href="<?php echo ADMIN_URL?>roomfeatures/list/"+Re;
}

/***************************************** Add New Features *******************************************/
function AddNewFeatures()
{
	window.location.href="<?php echo ADMIN_URL?>roomfeatures/addEdit";
}

/***************************************** Edit records *****************************************/
function editRecord(Re)
{
	window.location.href="<?php echo ADMIN_URL?>roomfeatures/addEdit/"+Re;
}
...
{
	window.location.href="<?php echo ADMIN_URL?>roomfeatures/featuresImageList/"+Re;
}
