<script language="javascript">
    ...
    function getLocation() {
        return '<?php echo BASE_URL;?>includes/controllers/ajax.level.php';
    }
    ...
    $(document).ready(function () {
        oTable = $('#example').dataTable({
            ...
            sURL: "<?php echo BASE_URL;?>includes/controllers/ajax.level.php?action=sort",
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (msg.action == 'success') {
                                ...
                                if (actionId == 2)
                                    setTimeout(function () {
                                        window.location.href = "<?php echo ADMIN_URL?>level/list";
                                    }, 3000);
                                if (actionId == 1)
                                    setTimeout(function () {
                                        window.location.href = "<?php echo ADMIN_URL?>level/addEdit";
                                    }, 3000);
                                if (actionId == 0)
                                    setTimeout(function () {
    ...
    function recordDelete(Re) {
        $('.MsgTitle').html('<?php echo sprintf($GLOBALS['basic']['deleteRecord_'], "Level")?>');
        $('.pText').html('Click on yes button to delete this Level permanently.!!');
    ...
    /***************************************** Edit records *****************************************/
    function editRecord(Re) {
        window.location.href = "<?php echo ADMIN_URL?>level/addEdit/" + Re;
    }
