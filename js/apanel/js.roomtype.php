...
function getLocation(){
	return '<?php echo BASE_URL;?>includes/controllers/ajax.roomtype.php';
}
...
function AddNewType()
{
	window.location.href="<?php echo ADMIN_URL?>roomtype/addEdit";
}

/***************************************** View roomtype link *******************************************/
function viewList()
{
	window.location.href="<?php echo ADMIN_URL?>roomtype/list";
}

/***************************************** Edit roomtype *******************************************/
function editRecord(Re)
{
	window.location.href="<?php echo ADMIN_URL?>roomtype/addEdit/"+Re;
}

/***************************************** AddEdit login Info *******************************************/
$(document).ready(function(){		
	// form submisstion actions		
	jQuery('#addEdit_Frm').validationEngine({
		autoHidePrompt:true,
		scroll: false,
		onValidationComplete: function(form, status){
			if(status==true){	
				...
				var data = $('#addEdit_Frm').serialize();
				...
				$.ajax({
				   ...
				   success: function(data){
					   ...
					   if(msg.action=='success'){
						   showMessage(msg.action,msg.message);							   
						   setTimeout( function(){window.location.href="<?php echo ADMIN_URL?>roomtype/list";},3000);
					   }
