<script language="javascript">
    ...
    function getLocation() {
        return '<?php echo BASE_URL;?>includes/controllers/ajax.bookinginfovehicle.php';
    }
    ...
    function viewBookinglist() {
        window.location.href = "<?php echo ADMIN_URL?>bookinginfovehicle/list";
    }

    /***************************************** Edit Booking link *******************************************/
    function viewRecord(Re) {
        window.location.href = "<?php echo ADMIN_URL?>bookinginfovehicle/view/" + Re;
    }
</script>