...
function getLocation(){
	return '<?php echo BASE_URL;?>includes/controllers/ajax.page.php';
}
function getTableId(){
	return 'table_dnd';
}
...
$(document).ready(function() {
	oTable = $('#example').dataTable({
		...
		"sPaginationType": "full_numbers"
		  ...
		  sURL:"<?php echo BASE_URL;?>includes/controllers/ajax.page.php?action=sort",
				...
				$.ajax({
				   ...
				   success: function(data){
					   ...
					   if(msg.action=='success'){
						   ...
						   if(actionId==2)
						   	setTimeout( function(){window.location.href="<?php echo ADMIN_URL?>page/list";},3000);						   	
						   if(actionId==1)	
						   	setTimeout( function(){window.location.href="<?php echo ADMIN_URL?>page/addEdit";},3000);						   	
						   if(actionId==0)
...
{
	window.location.href="<?php echo ADMIN_URL?>page/list";
}

/***************************************** Add New Pages *******************************************/
function AddNewPages()
{
	window.location.href="<?php echo ADMIN_URL?>page/addEdit";
}

/***************************************** Edit records *****************************************/
function editRecord(Re)
{
	window.location.href="<?php echo ADMIN_URL?>page/addEdit/"+Re;
}
...
/******************************** Remove saved Pages image ********************************/
function deleteSavedPagesimage(Re)
{
