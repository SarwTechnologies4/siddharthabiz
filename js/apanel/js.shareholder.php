                                ...
                                case 1:
                                    ...
                                    setTimeout(function() {
                                        window.location.href =
                                            "<?php echo ADMIN_URL?>shareholder/addEdit";
                                    }, 3000);
                                    break;
                                case 2:
                                    ...
                                    setTimeout(function() {
                                        window.location.href =
                                            "<?php echo ADMIN_URL?>shareholder/list";
                                    }, 3000);
                                    break;
                                default:
                                    console.log('sav3e');
...
/***************************************** View records *****************************************/
function viewDetail(Re) {
    window.location.href = "<?php echo ADMIN_URL ?>shareholder/viewDetail/" + Re;
}
    ...
    $(".botTempo").on("click", function() {
        ...
        if (popAct == 'yes') {
            $('#removeSavedimg' + Re).fadeOut(1000, function() {
                ...
                $('#preview_Image' + Re).html('<input type="hidden" name="imageArrayname' + Re +
                    '" value="" class=""/>');
            });
        } else {
            Re = '';
...
/***************************************** Add New dividend *******************************************/
function addDividend(Re) {
    window.location.href = "<?php echo ADMIN_URL ?>dividend/addNew/" + Re;
}

/***************************************** Add New investment *******************************************/
function addInvestment(Re) {
    window.location.href = "<?php echo ADMIN_URL ?>investment/addNew/" + Re;
}
