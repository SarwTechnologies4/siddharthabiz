<?php
$moduleTablename = "tbl_hotel_faqs"; // Database table name
$moduleId = 87;                // module id >>>>> tbl_modules
$moduleFoldername = "";        // Image folder name

if (isset($_GET['page']) && $_GET['page'] == "hotelfaq" && isset($_GET['mode']) && $_GET['mode'] == "list"):
    ?>
    <h3>
        List FAQs
    ...
    <div class="example-box">
        <div class="example-code">
            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                ...
                <tbody>
                <?php $records = Hotelfaq::find_by_sql("SELECT * FROM " . $moduleTablename . " ORDER BY sortorder ASC ");
...
<?php elseif (isset($_GET['mode']) && $_GET['mode'] == "addEdit"):
    if (isset($_GET['id']) && !empty($_GET['id'])):
        ...
        $faqInfo = Hotelfaq::find_by_id($pageId);
    ...
    <h3>
        ...
        <a class="loadingbar-demo btn medium bg-blue-alt float-right" href="javascript:void(0);" onClick="viewFAQList();">
            <span class="glyph-icon icon-separator">
            ...
            <form action="" class="col-md-12 center-margin" id="data_frm">
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10">
                        <input placeholder="FAQ Question" class="col-md-6 validate[required,length[0,200]]" type="text" name="title" id="title"
                ...
                <input myaction='0' type="hidden" name="idValue" id="idValue" value="<?php echo !empty($faqInfo->id) ? $faqInfo->id : 0; ?>"/>
            </form>
        </div>
    </div>
