...
$moduleId         = 52;             // module id >>>>> tbl_modules
    ...
    <div class="example-code">
        <form action="" class="col-md-12 center-margin" id="testimonial_frm">
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-6">
                    <input placeholder="Address" class="col-md-6 " type="text" name="country" id="country" value="<?php echo !empty($testimonialInfo->country)?$testimonialInfo->country:"";?>">
            ...
            <div class="form-row">
                ...
                <input type="hidden" name="imageArrayname" value="<?php echo !empty($testimonialInfo->image)?$testimonialInfo->image:"";?>" class="" />
                <?php endif;?>
