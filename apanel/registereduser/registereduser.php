...
// pr($_SESSION);
if (isset($_GET['page']) && $_GET['page'] == "registereduser" && isset($_GET['mode']) && $_GET['mode'] == "list"):
    ?>
    ...
    <div class="example-box">
        <div class="example-code">
            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                ...
                $records = Generaluser::find_by_sql("SELECT * FROM " . $moduleTablename . " WHERE type='general' AND status='0' ORDER BY sortorder DESC ");
...
<?php elseif (isset($_GET['mode']) && $_GET['mode'] == "addEdit"):
    ...
    <span class="glyph-icon icon-separator">
        ...
        <a class="loadingbar-demo btn medium bg-blue-alt float-right me-3 hide" href="javascript:void(0);" onClick="updateRecord(<?php echo $usersInfo->id; ?>);">
        ...
        <div class="col-sm-8 hide">
            ...
            <div class="example-box pt-0" style="border-top:0;">
                ...
                <form action="" method="post" id="the_form">
                    ...
                    <input type="button" name="export_selected_point" id="export_selected_point" value="Export Selected" class="btn medium bg-blue-alt" />
                    </div>
                    <div class="col-sm-4">
                    &nbsp;
                    <input type="button" name="export_all_point" id="export_all_point" value="Export All" class="btn meallexport dium bg-blue-alt " />
                    </div>
                    </div>
                </form>
                <div class="example-code">
                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                        ...
                        <th class="text-center hide">S.No.</th>
                            ...
                            <th class="text-left" width="30%">Particulars</th>
                            <th class="text-left" width="5%" title="Method of Payment">MOP</th>

                            <th class="text-left" width="5%" title="Transaction point">Pts</th>
                            <th class="text-left" width="5%"title="Useable Points">UP</th>
                            <th class="text-left" width="5%" title="Lifetime Points">LFT</th>
                            <th class="text-left" width="20%" title="Branch">Branch</th>
                            <?php     
                            if(!($user_type == "hotel" && isset($_GET['id']) && !empty($_GET['id']))){
                                echo '<th class="text-left" width="5%">Action</th>';
