        ...
        <form action="" class="col-md-12 center-margin" id="Preference_frm">
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-10 uploader2 <?php echo !empty($PrefeRow->logo_upload) ? "hide" : ""; ?>">
                    ...
                    <label><small>Image Dimensions (125 px X 80 px)</small></label>
                </div>
                <!-- Upload user image preview -->
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-6">
                    <textarea placeholder="Facebook Messenger Code" name="fb_messenger" id="fb_messenger"
            ...
            <div class="form-row <?php echo (!empty($PrefeRow->site_keywords) || !empty($PrefeRow->site_description)) ? '' : 'hide'; ?> metadata">
                <div class="col-md-6 form-input">
                    <input type="text" placeholder="Meta Title" name="meta_title" id="meta_title" class="validate[required]"
