...
if(isset($_GET['page']) && $_GET['page'] == "roomoffers" && isset($_GET['mode']) && $_GET['mode']=="list"):	
clearImages($moduleTablename, "roomoffers");
clearImages($moduleTablename, "roomoffers/thumbnails");
?>
<h3>
Offers Management <?php echo "'s of ".$hotel_detail->title;?>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
        ...
        <tbody>
            ...
            <tr id="<?php echo $record->id;?>">
                ...
                <td><?php echo set_na($record->date_from);?></td>
                <td><?php echo set_na($record->date_to);?></td>
                <td><?php echo set_na($record->discount);?> %</td>
...
?>
<h3>
<?php echo (isset($_GET['id']))?'Edit Offers':'Add Offers';?> <?php echo " [".$hotel_detail->title."]";?>
