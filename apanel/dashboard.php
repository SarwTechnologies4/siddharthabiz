<?php include("choose_hotel.php");?>
<!-- Dashbard Icons -->
<div class="row mrg20B">
<?php $parents = Module::find_all_parent($user_type);
if($loginUser->type == 'hotel' AND $loginUser->package_status==0) { unset($parents[2]); }
if($loginUser->type == 'hotel' AND $loginUser->vehicle_status==0) { unset($parents[3]); }
  $count = 0;
  $option = array();
  if($parents){
...
<?php if($loginUser->type == 'hotel' AND $loginUser->package_status==0) { ?>
<!--  <a href="--><?php //echo ADMIN_URL.'apply/triplist';?><!--" class="btn medium bg-blue-alt">&nbsp;&nbsp;Apply For Trip Service&nbsp;&nbsp;</a>-->
<?php }
if($loginUser->type == 'hotel' AND $loginUser->vehicle_status==0) { ?>
<!--  <a href="--><?php //echo ADMIN_URL.'apply/vehiclelist';?><!--" class="btn medium bg-blue-alt">&nbsp;&nbsp;Apply For Vehicle Service&nbsp;&nbsp;</a>-->
<?php } ?>
