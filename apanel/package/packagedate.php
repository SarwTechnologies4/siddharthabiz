            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table" id="subexample">
                ...
                foreach ($records as $key => $record): ?>
                    <tr id="<?php echo $record->id; ?>">
                        ...
                        <td>
                            <div class="col-md-7">
                                <a href="javascript:void(0);" onClick="editsubpackage(<?php echo $record->package_id; ?>,<?php echo $record->id; ?>);"
                                   class="loadingbar-demo" title="<?php echo $record->package_date; ?>"><?php echo $record->package_date; ?></a>
                            </div>
                        </td>
                        ...
                        <td class="text-center">
                            ...
                            <a href="javascript:void(0);" class="loadingbar-demo btn small bg-blue-alt tooltip-button" data-placement="top"
                               title="Edit" onclick="editsubpackage(<?php echo $record->package_id; ?>,<?php echo $record->id; ?>);">
            ...
            <form action="" class="col-md-12 center-margin" id="subpackage_frm">
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10">
                        <input placeholder="Package Date" class="col-md-2 validate[required]" type="text" name="package_date" id="package_date"
                               value="<?php echo !empty($packagedateInfo->package_date) ? $packagedateInfo->package_date : ""; ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-label col-md-2">
                        <label for="">
                            Days before booking closes :
                        </label>
                    </div>
                    <div class="form-input col-md-10">
                        <input placeholder="Closure Days" class="col-md-2 validate[required]" type="text" name="package_closure" id="package_closure"
                               value="<?php echo !empty($packagedateInfo->package_closure) ? $packagedateInfo->package_closure : ""; ?>">
                    </div>
                </div>
                ...
                <input myaction='0' type="hidden" name="idValue" id="idValue"
                       value="<?php echo !empty($packagedateInfo->id) ? $packagedateInfo->id : 0; ?>"/>
                <input type="hidden" name="package_currency" id="package_currency" value="USD"/>
                <input type="hidden" name="package_id" id="package_id"
                       value="<?php echo !empty($packagedateInfo->package_id) ? $packagedateInfo->package_id : $pid; ?>"/>
            </form>
        </div>
    </div>
<?php endif; ?>