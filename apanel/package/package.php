...
$moduleId = 70;                // module id >>>>> tbl_modules
...
if (isset($_GET['page']) && $_GET['page'] == "package" && isset($_GET['mode']) && $_GET['mode'] == "list"):
    ...
    JsonclearImages($moduleTablename, $moduleFoldername . "/banner", "banner_image");
    JsonclearImages($moduleTablename, $moduleFoldername . "/banner/thumbnails", "banner_image");
    ...
    JsonclearImages($moduleTablename, $moduleFoldername . "/gallery", "gallery");
    JsonclearImages($moduleTablename, $moduleFoldername . "/gallery/thumbnails", "gallery");
    ?>
    <h3>
        List Package
    ...
    <div class="example-box">
        <div class="example-code">
            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                ...
                <tbody>
                <?php if($loginUser->type == 'hotel') { $records = Package::find_by_sql("SELECT * FROM " . $moduleTablename . " WHERE added_by='".$loginUser->id."' ORDER BY sortorder ASC "); }
                else { $records = Package::find_by_sql("SELECT * FROM " . $moduleTablename . " ORDER BY sortorder ASC "); }
                        ...
                        <td>
                            <a class="primary-bg medium btn loadingbar-demo" title=""
                               onClick="viewsubimagelist(<?php echo $record->id; ?>);" href="javascript:void(0);">
                                <span class="button-content">
                                    <span class="badge bg-orange radius-all-4 mrg5R" title=""
                                          data-original-title="Badge with tooltip"><?php echo $countImages = PackageImage::getTotalImages($record->id); ?></span>
...
<?php elseif (isset($_GET['mode']) && $_GET['mode'] == "addEdit"):
        ...
        <div class="example-code">
            <form action="" class="col-md-12 center-margin" id="package_frm">
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10">
                        <input placeholder="Slug" name="slug" id="slug" class="col-md-3 validate[required,length[0,200]]" type="text"
                ...
                <div class="form-row add-image">
                    ...
                    <div id="preview_banner"><input type="hidden" name="imageArrayname2[]" class=""/></div>
                    <?php
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10">
                        ...
                        <select name="activityId" class="col-md-4 validate[required] actaction"
                            ...
                            <?php echo Activities::get_all_filter($selid); ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10">
                        <input placeholder="Route" class="col-md-4 validate[length[0,200]]" type="text"
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10">
                        <input placeholder="Map" class="col-md-4 validate[length[0,200]]" type="text"
                               name="mapgoogle" id="mapgoogle"
                               value="<?php echo !empty($packageInfo->mapgoogle) ? $packageInfo->mapgoogle : ""; ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10">
                        <div class="col-md-4" style="padding-left:0px !important;"> US ($)
                            <input placeholder="Price" class="col-md-4 validate[required, custom[number]]" type="text"
                                   name="price" id="price"
    ...
    <script>
        ...
        var editor_arr = ["overview", "incexc", "booking_info", "other_info"];
