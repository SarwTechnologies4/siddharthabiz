...
if(isset($_GET['id']) && !empty($_GET['id'])):
    ...
    $popular     = ($newsInfo->popular==1)?"checked":" ";
    $unpopular   = ($newsInfo->popular==0)?"checked":" ";
endif;	
?>
<h3>
    	...
    	<form action="" class="col-md-12 center-margin" id="news_frm">
           ...
           <!--  <div class="form-row">
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-6">
                    <input placeholder="Tags" class="col-md-6 validate[required,length[0,200]]" type="text" name="tags" id="tags" value="<?php echo !empty($newsInfo->tags)?$newsInfo->tags:"";?>">
                </div>                
            </div>
            <div class="form-row">
                <div class="form-label col-md-2">
            ...
            <div class="form-row add-image">
                ...
                <div class="form-row ">
                    <?php if (!empty($newsInfo->gallery)):
                        $imgall = unserialize($newsInfo->gallery);
                        if ($imgall) {
                            foreach ($imgall as $imgk => $imgv) { ?>
                                ...
                                <span class="float-left">
                                    <?php
                                    if (file_exists(SITE_ROOT . "images/news/gallery/" . $imgv)):
                                        $filesize = filesize(SITE_ROOT . "images/news/gallery/" . $imgv);
                                    ...
                                    ?>
                                        ...
                                        <img src="<?php echo IMAGE_PATH . 'news/gallery/thumbnails/' . $imgv; ?>"
                                             style="width:100%"/>
            ...
            <div class="form-row add-image <?php echo !empty($imghide)?$imghide:'';?>">
                ...
                <div class="col-md-3" id="removeSavedimg<?php echo $newsInfo->id;?>">
                    <div class="infobox info-bg">                            	                                
                        ...
                        <img src="<?php echo IMAGE_PATH.'news/thumbnails/'.$newsInfo->image;?>"  style="width:100%"/>   <input type="hidden" name="imageArrayname" value="<?php echo $newsInfo->image; ?>"/>
            ...
            <div class="form-row">   
                ...
                <div class="form-checkbox-radio col-md-9">
                    <input type="radio" class="custom-radio" name="popular" id="popular1" value="1" <?php echo !empty($popular)?$popular:"checked";?>>
                    <label for="">Popular</label>
                    <input type="radio" class="custom-radio" name="popular" id="popular0" value="0" <?php echo !empty($unpopular)?$unpopular:"";?>>
                    <label for="">Un-Popular</label>
                </div>                
            </div> 
            <!-- Meta Tags-->
            <div class="form-row">              
   ...
   /* 'checkExisting' : '/uploadify/check-exists.php',*/
    ...
    $('#gallery').uploadify({
                ...
                'formData': {
                    ...
                    targetFolder: 'images/news/gallery/',
                    thumb_width: 200,
                    thumb_height: 200
                },
                'method': 'post',
                ...
                'onUploadSuccess': function (file, data, response) {
                    $('#uploadedImageName').val('1');
                    var filename = data;
                    $.post('<?php echo BASE_URL;?>apanel/news/uploaded_gallery.php', {imagefile: filename}, function (msg) {
