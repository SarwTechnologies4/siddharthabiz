...
<div class="example-box">
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
        ...
        <tbody>
            <?php $records = User::find_by_sql("SELECT * FROM ".$moduleTablename." WHERE type='admin' ORDER BY sortorder ASC ");	
            ...
            <tr id="<?php echo $record->id;?>">
                ...
                <td class="text-center">
                    ...
                    <?php endif; ?>
                    <a href="javascript:void(0);" class="loadingbar-demo btn small bg-green tooltip-button hide" data-placement="top" title="Permissioin"
            ...
            <form action="" method="post" class="col-md-12 center-margin" id="permission_frm">
                <ul>
                    ...
                    foreach ($parentmenu as $key => $val) {
                        $childmenu = Module::find_child_by($val->id,'admin');
                        $res .= '<li>
