...
if (isset($_GET['page']) && $_GET['page'] == "roomapi" && isset($_GET['mode']) && $_GET['mode'] == "list"):
    JsonclearImagesNorace($tablename, "roomapi");
    JsonclearImagesNorace($tablename, "roomapi/thumbnails");

    clearImages($tablename,'roomapi/banner_image','banner_image');
    clearImages($tablename,'roomapi/banner_image/thumbnails','banner_image');
    ?>
    <h3>
        Manage Rooms <?php echo "'s of " . $hotel_detail->title; ?>
    ...
    <div class="example-box">
        <div class="example-code">
            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                ...
                <tbody>
                <?php $records = Roomapi::find_by_sql("SELECT * FROM " . $tablename . " WHERE 1=1 and hotel_id='" . $user_hotel_id . "' ORDER BY sortorder DESC ");
                foreach ($records as $key => $record): ?>
                    <tr id="<?php echo $record->id; ?>">
                        <td style="display:none;"><?php echo $key + 1; ?></td>
                        <td><input type="checkbox" class="bulkCheckbox" bulkId="<?php echo $record->id; ?>"/></td>
                        <td><a href="javascript:void(0);" onClick="editsubroom(<?php echo @$record->type; ?>,<?php echo $record->id; ?>);"
                        ...
                        <td class="text-center">
                            ...
                            ?>
                            <a href="javascript:void(0);" class="btn small <?php echo $statusImage; ?> tooltip-button statusSubToggler"
...
<?php elseif (isset($_GET['mode']) && $_GET['mode'] == "form"):
    ...
    ?>
    <h3>
        <?php echo (isset($_GET['id'])) ? 'Edit Room' : 'Add Room'; ?><?php echo " [" . $hotel_detail->title . "]"; ?>
        ...
        <div class="example-code">
            <form action="" method="post" class="col-md-12 center-margin" id="roomapi_frm">
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input placeholder="Room Title" class="col-md-12 validate[required,length[0,100]]" type="text" name="title" id="title"
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <select data-placeholder="Room Type" class="chosen-select validate[required,length[0,500]]" id="room_type" name="room_type">
                            ...
                            <?php
                            //$roomType = Roomtype::find_all_by_type($user_hotel_id);
                            $roomType = Roomtype::find_all();
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input class="col-md-2 validate[required,length[0,20]]" type="text" name="room_size" id="room_size"
                               value="<?php echo !empty($rowInfo->room_size) ? $rowInfo->room_size : ""; ?>">
                        square
                        <select name="room_size_label" id="room_size_label" class="col-md-2">
                            <option value="meters" <?php echo (!empty($rowInfo->room_size_label) && $rowInfo->room_size_label == 'meters') ? "selected" : ""; ?> >
                                Meters
                            </option>
                            <option value="feet" <?php echo (!empty($rowInfo->room_size_label) && $rowInfo->room_size_label == 'feet') ? "selected" : ""; ?> >
                                Feet
                            </option>
                        </select>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <select name="smoking" id="smoking" class="col-md-4">
                            <option value="yes" <?php echo (!empty($rowInfo->smoking) && $rowInfo->smoking == 'yes') ? "selected" : ""; ?> >Can
                                Smoke
                            </option>
                            <option value="no" <?php echo (!empty($rowInfo->smoking) && $rowInfo->smoking == 'no') ? "selected" : ""; ?> >Non
                                Smoking
                            </option>
                            <option value="both" <?php echo (!empty($rowInfo->smoking) && $rowInfo->smoking == 'both') ? "selected" : ""; ?> >Both
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input class="col-md-4 validate[length[0,2]]" placeholder="Bed Type" type="text" name="bed_type" id="bed_type"
                               value="<?php echo !empty($rowInfo->bed_type) ? $rowInfo->bed_type : ""; ?>">
                        <br>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input class="col-md-2 validate[length[0,2]]" type="text" name="single_bed" id="single_bed"
                               value="<?php echo !empty($rowInfo->single_bed) ? $rowInfo->single_bed : ""; ?>">
                        <br>
                        <small>90-130 cm (35-51 inches) wide</small>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input class="col-md-2 validate[length[0,2]]" type="text" name="double_bed" id="double_bed"
                               value="<?php echo !empty($rowInfo->double_bed) ? $rowInfo->double_bed : ""; ?>">
                        <br>
                        <small>131-150 cm (52-59 inches) wide</small>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input class="col-md-2 validate[length[0,2]]" type="text" name="large_double" id="large_double"
                               value="<?php echo !empty($rowInfo->large_double) ? $rowInfo->large_double : ""; ?>">
                        <br>
                        <small>151-180 cm (60-70 inches) wide</small>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input class="col-md-2 validate[length[0,2]]" type="text" name="extra_large_double" id="extra_large_double"
                               value="<?php echo !empty($rowInfo->extra_large_double) ? $rowInfo->extra_large_double : ""; ?>">
                        <br>
                        <small>181-210 cm (71-82 inches) wide</small>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input class="col-md-2 validate[length[0,2]]" type="text" name="bunk_bed" id="bunk_bed"
                               value="<?php echo !empty($rowInfo->bunk_bed) ? $rowInfo->bunk_bed : ""; ?>">
                        <br>
                        <small>Variable Size</small>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input class="col-md-2 validate[length[0,2]]" type="text" name="sofa_bed" id="sofa_bed"
                               value="<?php echo !empty($rowInfo->sofa_bed) ? $rowInfo->sofa_bed : ""; ?>">
                        <br>
                        <small>Variable Size</small>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input class="col-md-2 validate[length[0,2]]" type="text" name="futon_bed" id="futon_bed"
                               value="<?php echo !empty($rowInfo->futon_bed) ? $rowInfo->futon_bed : ""; ?>">
                        <br>
                        <small>Variable Size</small>
                    </div>
                </div> -->
                    ...
                    foreach ($RecFearures as $recRow) { ?>
                        <div class="form-row">
                            ...
                            <div class="form-checkbox-radio col-md-10 form-input">
                                    ...
                                    foreach ($childRec as $childRow) {
                                        ...
                                        <div><input type="checkbox" class="custom-radio"
                                            ...
                                            <input type="text" placeholder="Title" class="col-md-6 validate[length[0,100]]"
                                                   ...
                                                   value="<?php echo $child_title; ?>"><br></div>
                                        <?php
                                        $i++;
                                    }
                                } ?>
                                ...
                                <a href="javascript:void(0);" class="btn medium bg-blue tooltip-button" title="Add"
                                   onclick="addFeaturesRows('<?php echo $recRow->id; ?>');">
                                    <i class="glyph-icon icon-plus-square"></i>
                                </a>
                            </div>
                        </div>
                ...
                <!-- <div class="form-row">
                    ...
                    <div class="form-checkbox-radio col-md-10 form-input">
                        <a href="javascript:void(0);" class="btn medium bg-blue tooltip-button" title="Add" onclick="addFacilityRows();"><i
                                    class="glyph-icon icon-plus-square"></i></a>
                    </div>
                </div> -->
                <hr/>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input placeholder="No. of Rooms" class="col-md-3 validate[length[0,2]]" type="text" name="no_rooms" id="no_rooms"
                               value="<?php echo !empty($rowInfo->no_rooms) ? $rowInfo->no_rooms : ""; ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input class="col-md-2 validate[required,custom[integer],length[0,2]]" type="text" name="max_people" id="max_people"
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input class="col-md-2 validate[custom[integer],length[0,2]]" type="text" name="max_child" id="max_child"
                               value="<?php echo !empty($rowInfo->max_child) ? $rowInfo->max_child : ""; ?>">
                        <br>
                        <small>This is the maximum number of children that can stay in this room for free. The maximum age of these children is 6.
                        </small>
                    </div>
                </div>
            ...
            -->
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10">
                        <div class="col-md-2 hide rmovprice1">
                            <label>1 no. of: </label>
                            <input placeholder="Price" class="validate[required,length[0,7]]" type="text" name="room_price[0][]" id="room_price1"
                                   value="<?php echo !empty($rec2->one_person) ? $rec2->one_person : ''; ?>">
                        </div>
                        <div class="col-md-2 hide rmovprice2">
                            <label>2 no. of: </label>
                            <input placeholder="Price" class="validate[required,length[0,7]]" type="text" name="room_price[0][]" id="room_price2"
                                   value="<?php echo !empty($rec2->two_person) ? $rec2->two_person : ''; ?>">
                        </div>
                        <div class="col-md-2 hide rmovprice3">
                            <label>3 no. of: </label>
                            <input placeholder="Price" class="validate[required,length[0,7]]" type="text" name="room_price[0][]" id="room_price3"
                                   value="<?php echo !empty($rec2->three_person) ? $rec2->three_person : ''; ?>">
                        </div>
                        <div class="col-md-2 hide rmovprice4">
                            <label>Extra Bed: </label>
                            <input placeholder="Price" class="validate[groupRequired,length[0,7]]" type="text" name="room_price[0][]" id="room_price4"
                                   value="<?php echo !empty($rec2->extra_bed) ? $rec2->extra_bed : ''; ?>">
                        </div>
                    </div>
                </div>
                <?php
                $sesrec = Season::get_all_by_type($user_hotel_id);
                if ($sesrec) {
                            ...
                            <div class="form-input col-md-10">
                                <div class="col-md-2 hide rmovprice1">
                                    ...
                                    <input placeholder="Price" class="validate[groupRequired,length[0,7]]" type="text"
                                           name="room_price[<?php echo $sesrow->id; ?>][]" id="room_price1"
                                           value="<?php echo !empty($rec->one_person) ? $rec->one_person : ''; ?>">
                                </div>
                                <div class="col-md-2 hide rmovprice2">
                                    <label>2 no. of: </label>
                                    <input placeholder="Price" class="validate[groupRequired,length[0,7]]" type="text"
                                           name="room_price[<?php echo $sesrow->id; ?>][]" id="room_price2"
                                           value="<?php echo !empty($rec->two_person) ? $rec->two_person : ''; ?>">
                                </div>
                                <div class="col-md-2 hide rmovprice3">
                                    <label>3 no. of: </label>
                                    <input placeholder="Price" class="validate[groupRequired,length[0,7]]" type="text"
                                           name="room_price[<?php echo $sesrow->id; ?>][]" id="room_price3"
                                           value="<?php echo !empty($rec->three_person) ? $rec->three_person : ''; ?>">
                                </div>
                                <div class="col-md-2 hide rmovprice4">
                                    <label>Extra Bed: </label>
                                    <input placeholder="Price" class="validate[groupRequired,length[0,7]]" type="text"
                                           name="room_price[<?php echo $sesrow->id; ?>][]" id="room_price4"
                                           value="<?php echo !empty($rec->extra_bed) ? $rec->extra_bed : ''; ?>">
                                </div>
                            </div>
                        </div>
                    <?php }
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <!--<input class="col-md-2 validate[required,custom[integer],length[0,2]]" type="text" name="extra_bed" id="extra_bed"
                           value="<?php echo !empty($rowInfo->extra_bed) ? $rowInfo->extra_bed : ""; ?>">-->
                        <input class="col-md-2 validate[custom[integer],length[0,2]]" type="text" name="extra_bed" id="extra_bed"
