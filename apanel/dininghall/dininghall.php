<?php
$tablename      = "tbl_dining_hall";
$user_hotel_id  = $session->get('user_hotel_id');
$hotel_detail   = Hotelapi::find_by_id($user_hotel_id);

if (isset($_GET['page']) && $_GET['page'] == "dininghall" && isset($_GET['mode']) && $_GET['mode'] == "list"):
    clearImages($tablename, 'dininghall');
    clearImages($tablename, 'dininghall/thumbnails');
    ?>
    <h3>
        Manage Dining Hall<?php echo "'s of " . $hotel_detail->title; ?>
        <a class="loadingbar-demo btn medium bg-blue-alt float-right" href="javascript:void(0);" onClick="addNewDiningHall();">
    ...
    <div class="example-box">
        <div class="example-code">
            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                ...
                <tbody>
                <?php $records = DiningHall::find_by_sql("SELECT * FROM " . $tablename . " WHERE 1=1 and hotel_id='" . $user_hotel_id . "' ORDER BY sortorder DESC ");
...
<?php elseif (isset($_GET['mode']) && $_GET['mode'] == "form"):
    if (isset($_GET['id']) and !empty($_GET['id'])):
        ...
        $rowInfo    = DiningHall::find_by_id($rowId);
    ...
    <h3>
        ...
        <a class="loadingbar-demo btn medium bg-blue-alt float-right" href="javascript:void(0);" onClick="viewDiningHallList();">
    ...
    <div class="example-box">
        <div class="example-code">
            <form action="" method="post" class="col-md-12 center-margin" id="dining_hall_frm">
                ...
                <div class="form-row">
                    ...
                    if (!empty($rowInfo->image)):
                        ...
                        <div class="col-md-3" id="removeSavedimg001">
                            <?php
                            if (file_exists(SITE_ROOT . "images/dininghall/" . $imageRow2)):?>
                                <div class="infobox info-bg">
                                    <div class="button-group" data-toggle="buttons">
                                    <span class="float-left">
                                        <?php
                                        $filesize = filesize(SITE_ROOT . "images/dininghall/" . $imageRow2);
                                    ...
                                    <img src="<?php echo IMAGE_PATH . 'dininghall/thumbnails/' . $imageRow2; ?>" style="width:100%"/>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#image_upload').uploadify({
                ...
                'formData':     {PROJECT: '<?php echo SITE_FOLDER;?>', targetFolder: 'images/dininghall/', thumb_width: 380, thumb_height: 478},
                'method':       'post',
                ...
                'onUploadSuccess': function (file, data, response) {
                    var filename = data;
                    $.post('<?php echo BASE_URL;?>apanel/dininghall/uploaded_image.php', {imagefile: filename}, function (msg) {
