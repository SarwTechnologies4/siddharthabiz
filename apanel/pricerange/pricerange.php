...
<?php
$moduleTablename = "tbl_pricerange"; // Database table name
$moduleId = 32;             // module id >>>>> tbl_modules
$moduleFoldername = "popup";        // Image folder name

$packages = array(0=>'Package', 1=>'A La Carta');

if (isset($_GET['page']) && $_GET['page'] == "pricerange" && isset($_GET['mode']) && $_GET['mode'] == "list"):
        ...
        <div class="example-code">
            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                ...
                <tr>
                    ...
                    <th class="text-left">Price Consume Range</th>
                    <th class="text-left">Reward Points per consume</th>
                ...
                <tbody>
                <?php $records = Pricerange::find_by_sql("SELECT * FROM " . $moduleTablename . " ORDER BY sortorder DESC ");
                    ...
                    <tr id="<?php echo $record->id; ?>">
                        ...
                        <td>
                            <div class="">
                                <a href="javascript:void(0);" onClick="editRecord(<?php echo $record->id; ?>);"
                                   ...
                                   echo $pkgtype ."Rs. " . $record->fromrange . "- Rs. " . $record->torange; ?>">
                                   <?php $pkgtype ='';
                                   if($record->pkgtype == 0){
                                    $pkgtype = "Package : ";
                                   }elseif($record->pkgtype == 1){
                                    ...
                                    echo $pkgtype . "Rs. " . $record->fromrange . "- Rs. " . $record->torange; ?></a>
                            </div>
                        </td>
                        ...
                        <td>
                            <div style="display:flex;">
                                ...
                                <?php
                                // $svfr = !empty($record->feature) ? $record->feature : '';
                                // $saveRec = unserialize(base64_decode($svfr));
                                // $savedFeatures = isset($saveRec) ? $saveRec : array();
                                // $childRec = Level::get_allthepopup();
                                // if ($childRec) {
                                //     $i = 1;
                                //     foreach ($childRec as $childRow) {
                                //         $child_id = $childRow->id;
                                //         $check = '';
                                //         $child_title = isset($savedFeatures[$child_id]['id']) ? $childRow->title : $childRow->title;
                                //         $child_icon = isset($savedFeatures[$child_id]['id']) ? $savedFeatures[$child_id]['reward_point'] : 'N/A';
                                //         $check = isset($savedFeatures[$child_id]['id']) ? 'checked="checked"' : 'N/A'; ?>
                                        
                                            <!-- <div style="background:#e3e1e1;padding:0 5px;margin-right:2px;border-radius:4px;"><?php echo $child_title;?> - <?php echo $child_icon; ?></div> -->
                                ...
                                <?php
                                    ...
                                    //             $check = isset($childRow['id']) ? 'checked="checked"' : ''; ?>
                                                     ...
                                                     <!-- <label class="col-md-6"><?php echo $childRow['title'];?></label>
                                                     <label><?php echo $childRow['reward_point']; ?></label>
                                                    <br> -->
...
<?php elseif (isset($_GET['mode']) && $_GET['mode'] == "addEdit"):
    if (isset($_GET['id']) && !empty($_GET['id'])):
        ...
        $popupInfo = Pricerange::find_by_id($popupId);
        $status = ($popupInfo->status == 1) ? "checked" : " ";
        $unstatus = ($popupInfo->status == 0) ? "checked" : " ";

        $alacarta = ($popupInfo->pkgtype == 1) ? "checked" : " ";
        $package = ($popupInfo->pkgtype == 0) ? "checked" : " ";
    ...
    ?>
    <h3>
        <?php echo (isset($_GET['id'])) ? 'Edit Point' : 'Add Point'; ?>
        <a class="loadingbar-demo btn medium bg-blue-alt float-right" href="javascript:void(0);"
            ...
            <form action="" class="col-md-12 center-margin" id="popup_frm">
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10">
                        Rs. <input placeholder="From" class="col-md-6 validate[required,length[0,200]]" type="text"
                               name="fromrange" id="fromrange"
                               value="<?php echo !empty($popupInfo->fromrange) ? $popupInfo->fromrange : ""; ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10">
                        Rs. <input placeholder="To" class="col-md-6 validate[required,length[0,200]]" type="text"
                               name="torange" id="torange"
                               value="<?php echo !empty($popupInfo->torange) ? $popupInfo->torange : ""; ?>">
                    </div>
                </div>

                <!-- Feature Listing -->
                <?php $svfr = !empty($popupInfo->feature) ? $popupInfo->feature : '';
                $saveRec = unserialize(base64_decode($svfr));
                ...
                //     foreach ($RecFearures as $recRow) { ?>
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-10">
                                 <input placeholder="Points" class="col-md-6 validate[required,length[0,200]]" type="number"
                                    name="point" id="point"
                            ...
                            <!-- <div class="form-checkbox-radio col-md-10 form-input">
                                ...
                                if ($childRec) {
                                    ...
                                    foreach ($childRec as $childRow) {
                                        ...
                                        $child_icon = isset($savedFeatures[$child_id]['id']) ? $savedFeatures[$child_id]['reward_point'] : '';
                                        $check = isset($savedFeatures[$child_id]['id']) ? 'checked="checked"' : ''; ?>
                                        <div><input type="text" class="hide"
                                                    name="feature[<?php echo $child_id; ?>][id]"
                                                    value="<?php echo $childRow->id; ?>">
                                            <input type="text" placeholder="Title" class="col-md-6 hide"
                                                   name="feature[<?php echo $child_id; ?>][title]"
                                                   value="<?php echo $child_title; ?>">
                                            <label class="col-md-3"><?php echo $child_title;?></label>
                                            <input type="text" placeholder="Reward Point" class="col-md-2 validate[required,length[0,30]]"
                                                   name="feature[<?php echo $child_id; ?>][reward_point]"
                                        ...
                                        foreach ($savedFeatures as $childKey => $childRow) {
                                            ...
                                            if (!in_array($child_id, $id_arr)):
                                                ...
                                                <div><input type="text" class="hide"
                                                    ...
                                                    <label class="col-md-3"><?php echo $childRow['title'];?></label>

                                                    <input type="text" placeholder="Reward Point" class="col-md-2 validate[required,length[0,30]]"
                                                        name="feature[<?php echo $child_id; ?>][reward_point]"
                                                        value="<?php echo $childRow['reward_point']; ?>">
                ...
                if (is_array($saveRec) and sizeof($saveRec) > 0) {
                            ...
                            <!-- <div class="form-row">
                                ...
                                <div class="form-checkbox-radio col-md-10 form-input">
                                    ...
                                    <div class="clear"></div> -->
                                    <?php                                            
                    foreach ($saveRec as $childKey => $childRow) {
                        if (!in_array($childRow['id'], $id_arr)):
                                    if ($childRow) {
                                        $i = 1;
                                        // pr($childRow);
                                            ...
                                            <!-- <div><input type="text" class="hide"
                                                ...
                                                <input type="text" placeholder="Title" class="col-md-6 hide"
                                                       name="feature[<?php echo $child_id; ?>][title]"
                                                       value="<?php echo $childRow['title']; ?>">
                                                <span class="col-md-6"><?php echo $childRow['title'];?></span>
                                                <input type="text" placeholder="Reward Point" class="col-md-2 validate[length[0,30]]"
                                                       name="feature[<?php echo $child_id; ?>][reward_point]"
                                                       value="<?php echo $childRow['reward_point']; ?>">
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10">
                        <textarea name="description" id="description"
                                    class="medium-textarea"><?php echo !empty($popupInfo->description) ? $popupInfo->description : ""; ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-checkbox-radio col-md-9">
                        <input type="radio" class="custom-radio" name="pkgtype" id="check1"
                               value="1" <?php echo !empty($alacarta) ? $alacarta : "checked"; ?>>
                        <label for="">A La Carta</label>
                        <input type="radio" class="custom-radio" name="pkgtype" id="check0"
                               value="0" <?php echo !empty($package) ? $package : ""; ?>>
