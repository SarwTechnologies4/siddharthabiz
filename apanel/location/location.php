    ...
    <div class="example-code">
    	<form action="" class="col-md-12 center-margin" id="location_frm">
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-10">
                    <input placeholder="Phone No." class="col-md-6" type="text" name="contact_phone" id="contact_phone" value="<?php echo !empty($locationRow->contact_phone)?$locationRow->contact_phone:"";?>">
                </div>                
            </div>
            <div class="form-row">
                <div class="form-label col-md-2">
