...
?>
<h3>
List Season <?php echo "'s of ".$hotel_detail->title;?>
...
<div class="example-box">
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
        ...
        <tbody>
            <?php $records = Season::find_by_sql("SELECT * FROM ".$moduleTablename." WHERE 1=1 and hotel_id='".$user_hotel_id."' ORDER BY sortorder ASC "); 
...
<h3>
    <?php echo (isset($_GET['id']))?'Edit Season':'Add Season';?> <?php echo " [".$hotel_detail->title."]";?>
