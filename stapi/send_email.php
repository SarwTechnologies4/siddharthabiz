...
<html>
	                ...
	                <tr>
	                    <td>
	                        ...
	                        $admin_header.='<table width="100%" border="0" cellspacing="0" cellpadding="0">
	                            ...
	                            <tr>
	                                <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">Your room reservation is now confirmed. We have got booking with following details</td>
	                            </tr>
	                        </table>';

	                        $client_header.='<table width="100%" border="0" cellspacing="0" cellpadding="0">
	                            <tr>
	                                <td align="center" style="font-size: 18px; font-family: Helvetica, Arial, sans-serif; color: #333333;" class="padding-copy">Room reservation from '.$fullname.' !</td>
	                            </tr>
	                            <tr>
	                                <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">We have got booking with following details</td>
	                            </tr>
	                        </table>';
    ...
    $mail->Subject    = " Rooms Reservation - ".$hotel_name;
